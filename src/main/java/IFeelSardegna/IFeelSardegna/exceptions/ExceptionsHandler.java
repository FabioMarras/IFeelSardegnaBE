...
import IFeelSardegna.IFeelSardegna.payloads.errors.ErrorsDTO;
import IFeelSardegna.IFeelSardegna.payloads.errors.ErrorsWithListDTO;
...
public class ExceptionsHandler {
    ...
    public ErrorsDTO handleGeneric(Exception e) {
        e.printStackTrace();
        return new ErrorsDTO("Problema lato server, risolveremo presto", new Date());
    }
}
